...
class Grid extends Component {
	...
	renderModal = () => {
		const { fields, details, modalInputs, submit, cancel } = this.props
		return <Modal fields={fields} item={details} modalInputs={modalInputs} submit={submit} cancel={cancel} />
	}

	render() {
		const { fields, mods, className, showModal } = this.props
		if (fields) {
			return (
...
class StyledMoney extends Formatter {
	render() {
