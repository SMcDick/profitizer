const fields = [
	{ name: "Date", type: "date", format: "date", width: 100, className: "alignleft" },
	{ name: "Gross Sales", format: "positiveMoney" },
	{ name: "Refund Amount", heading: "Refunds", format: "positiveMoney" },
	{ name: "Net Sales", format: "positiveMoney" },
	{ name: "FVF", format: "negativeMoney" },
	{ name: "Trx", format: "negativeMoney" },
	{ name: "Total Fees", format: "negativeMoney" },
