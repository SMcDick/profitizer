...
class Item extends Component {
    ...
    static getDerivedStateFromProps( props ){
        let item = props.inventory.find( item => item.Item_Id.toString() === props.routerProps.match.params.id.toString() )
        let state = {
    ...
    render() {
        ...
        return (
            <div>
                ...
                { ! this.state.edit && <Link to={ "/inventory/" + this.props.routerProps.match.params.id + '/edit' }>Edit</Link> }
                <Form
